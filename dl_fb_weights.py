...
"""
This is just directly taken from the colab notebook at:
https://colab.research.google.com/github/facebookresearch/detr/blob/colab/notebooks/detr_demo.ipynb

All we do is instantiate the model and load the state_dicts of the submodules to make sure
there are no mistakes in the process.
"""
